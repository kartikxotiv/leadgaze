-- Setup Invitation System Tables
-- Run this in pgAdmin for the 'crm' database
...
-- 2. Create org_user_accounts table (for per-organization identities)
...
-- Create indexes for org_user_accounts
