      ...
      */}
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              'bg-leadgaze-primary text-white flex h-16 shrink-0 items-center justify-between border-b border-header-primary/20 px-3 md:px-6 justify-start',
              {
          ...
          */}
          <div className={'flex flex-1 flex-col min-h-0 bg-graylight dark:dark-background-color'}>
            <div className="flex flex-1 flex-col min-h-0 overflow-y-auto px-6 lg:px-12 py-4">
              {Children}
            </div>
          </div>
        </div>
