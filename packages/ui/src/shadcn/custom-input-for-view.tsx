  ...
  return (
    <div className={cn('flex flex-col gap-1.5', className)}>
      ...
      {isPrimitive ? (
        ...
        <div className="flex min-h-[37.5px] w-full items-center rounded-[4px] border border-[#B0B0B0] bg-white px-3 py-1 text-base shadow-2xs md:text-sm dark:border-slate-700 dark:bg-slate-900 dark:text-white">
          {value}
        </div>
      )}
    </div>
