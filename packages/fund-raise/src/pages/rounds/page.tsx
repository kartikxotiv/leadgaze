          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {[...Array(6)].map((_, i) => (
                  <TableRow key={i}>
                    <TableCell className="h-[52px] px-4 py-2" colSpan={9}>
