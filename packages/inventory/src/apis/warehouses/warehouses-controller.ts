...
export const getWarehousesController = catchAsync(async ({ request }) => {
  ...
  await assertInventoryPermission({
    ...
    userId: user.id,
    workspaceId,
    moduleKey: 'inventory_warehouses',
    featureKey: 'view',
  });

  return successDataResponse(
    'Warehouses controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_warehouses', featureKey: 'view' },
  );
});
