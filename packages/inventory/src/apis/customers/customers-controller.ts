...
export const getCustomersController = catchAsync(async ({ request }) => {
  ...
  await assertInventoryPermission({
    ...
    userId: user.id,
    workspaceId,
    moduleKey: 'inventory_customers',
    featureKey: 'view',
  });

  return successDataResponse(
    'Customers controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_customers', featureKey: 'view' },
  );
});
