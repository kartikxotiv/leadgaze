...
export const getProductsController = catchAsync(async ({ request }) => {
  ...
  return successDataResponse(
    'Products controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_products', featureKey: 'view' },
  );
});
