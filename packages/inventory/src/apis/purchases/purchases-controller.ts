...
export const getPurchasesController = catchAsync(async ({ request }) => {
  ...
  await assertInventoryPermission({
    ...
    userId: user.id,
    workspaceId,
    moduleKey: 'inventory_purchases',
    featureKey: 'view',
  });

  return successDataResponse(
    'Purchases controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_purchases', featureKey: 'view' },
  );
});
