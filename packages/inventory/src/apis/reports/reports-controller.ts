...
export const getReportsController = catchAsync(async ({ request }) => {
  ...
  await assertInventoryPermission({
    ...
    userId: user.id,
    workspaceId,
    moduleKey: 'inventory_reports',
    featureKey: 'view',
  });

  return successDataResponse(
    'Reports controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_reports', featureKey: 'view' },
  );
});
