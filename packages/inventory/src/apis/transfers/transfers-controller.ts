...
export const getTransfersController = catchAsync(async ({ request }) => {
  ...
  return successDataResponse(
    'Transfers controller scaffold is ready',
    { workspaceId, moduleKey: 'inventory_stock', featureKey: 'transfer' },
  );
});
