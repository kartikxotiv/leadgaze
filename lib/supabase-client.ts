...
if (!supabaseUrl) {
  const errorMsg =
    "Missing Supabase URL. Set NEXT_PUBLIC_SUPABASE_URL or SUPABASE_URL in your .env.local file.\n" +
...
if (!supabaseServiceKey) {
  const errorMsg =
    "Missing Supabase Service Role Key. Set SUPABASE_SERVICE_ROLE_KEY in your .env.local file.\n" +
...
if (supabaseUrl.includes("localhost") || supabaseUrl.includes("127.0.0.1")) {
  ...
  console.error(
    "   Supabase URL should be: https://your-project-id.supabase.co"
  );
