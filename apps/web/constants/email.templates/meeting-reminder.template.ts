...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <!-- Header -->
    <div style="background: linear-gradient(135deg, #4299e1 0%, #3182ce 100%); padding: 32px 24px; text-align: center;">
      <div style="background-color: rgba(255,255,255,0.2); display: inline-block; padding: 8px 16px; border-radius: 20px; margin-bottom: 12px;">
        <span style="color: #ffffff; font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">${intervalLabel}</span>
      </div>
      <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 600;">📅 Meeting Reminder</h1>
    </div>
    
    <!-- Content -->
    <div style="padding: 32px 24px;">
      <h2 style="margin: 0 0 16px 0; color: #1a202c; font-size: 20px; font-weight: 600;">${meetingTitle}</h2>
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tr>
            <td style="padding: 8px 0;">
              <p style="margin: 0; color: #2c5282; font-size: 13px; font-weight: 600; text-transform: uppercase;">Start</p>
              <p style="margin: 4px 0 0 0; color: #1a202c; font-size: 16px; font-weight: 500;">${formatDate(startTime)}</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 8px 0;">
              <p style="margin: 0; color: #2c5282; font-size: 13px; font-weight: 600; text-transform: uppercase;">End</p>
      ...
      <div style="margin: 24px 0;">
        <a href="${meetingLink}" style="display: inline-block; background-color: #4299e1; color: #ffffff; text-decoration: none; padding: 12px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; text-align: center;">
          Join Meeting
        </a>
      </div>
      `
    ...
    <div style="background-color: #f7fafc; padding: 20px 24px; text-align: center; border-top: 1px solid #e2e8f0;">
      ...
      <p style="margin: 12px 0 0 0; color: #a0aec0; font-size: 12px;">
        A product by <a href="https://programea.com" target="_blank" rel="noopener noreferrer" style="color: #4299e1; text-decoration: none;">Programea LLC</a>
      </p>
    </div>
  </div>
</body>
