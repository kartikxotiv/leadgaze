...
VALUES
  ...
  ('hrms_attendance', 'HRMS Attendance', 'Manage attendance records', 54, TRUE),
  ('hrms_leave', 'HRMS Leave', 'Manage leave requests and holidays', 55, TRUE),
  ('hrms_payroll', 'HRMS Payroll', 'Manage payroll records', 61, TRUE),
