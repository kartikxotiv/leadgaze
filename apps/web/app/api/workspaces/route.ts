...
export async function POST(request: Request) {
  try {
    ...
    const roles = [
      { role_key: 'admin', role_name: 'Admin', hierarchy_level: 100, is_system: true },
      { role_key: 'manager', role_name: 'Manager', hierarchy_level: 50, is_system: true },
      { role_key: 'user', role_name: 'User', hierarchy_level: 10, is_system: true },
      { role_key: 'viewer', role_name: 'Viewer', hierarchy_level: 1, is_system: true },
    ];
