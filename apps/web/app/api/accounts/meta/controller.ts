...
export const getAccountsMeta = catchAsync(async ({ request }: { request: NextRequest }) => {
  ...
  try {
    ...
    // 3. Fetch CRM Module ID for accounts from public schema
    ...
    console.error('getAccountsMeta Error:', err);
    throw err;
  }
});
