...
async function getIconAsBase64(id: string): Promise<string | null> {
...
function generateDonutChartBase64(data: { value: number; color: string }[], size = 200, holeRatio = 0.6): string {
