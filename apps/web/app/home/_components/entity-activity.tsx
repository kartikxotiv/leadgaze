...
export function EntityReminders({ entityType, entityId }: EntityActivityProps) {
  ...
  return (
    <CardWidgetContainer
      ...
      icon={<AlertCircle className="text-leadgaze-dark h-5 w-5" />}
      icon2={
        <Dialog
          open={isOpen}
          onOpenChange={(open) => {
...
export function EntityMeetings({ entityType, entityId }: EntityActivityProps) {
  ...
  return (
    <CardWidgetContainer
      title="Meetings"
      hideHeaderBorder={true}
      icon={<Calendar className="text-leadgaze-dark h-5 w-5" />}
      icon2={
        canScheduleMeeting && (
          <Dialog
            open={isOpen}
...
export function EntityDocuments({ entityType, entityId }: EntityActivityProps) {
  ...
  return (
    <CardWidgetContainer
      title="Documents"
      hideHeaderBorder={true}
      icon={<Download className="text-leadgaze-dark h-5 w-5" />}
      icon2={
        <Dialog
          open={isOpen}
          onOpenChange={(open) => {
