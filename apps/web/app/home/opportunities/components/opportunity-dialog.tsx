      ...
      <Form {...form}>
        <form id="dialog-form" onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 overflow-y-auto px-2 space-y-2 mb-2">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Opportunity Name <span className='text-red-600'>*</span></FormLabel>
                <FormControl>
          ...
          <div className="grid grid-cols-2 gap-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  <FormLabel>Account <span className='text-red-600'>*</span></FormLabel>
                  <Popover
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Stage <span className='text-red-600'>*</span></FormLabel>
                  <FormControl>
