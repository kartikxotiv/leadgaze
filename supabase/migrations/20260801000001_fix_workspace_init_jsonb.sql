-- Migration: Fix workspace initialization RPC function
-- Fix: Correct CTE scope and JSONB aggregation issues
...
ON workspace_members(workspace_id, product_key, status) 
