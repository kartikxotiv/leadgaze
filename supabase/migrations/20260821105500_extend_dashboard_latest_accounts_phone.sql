-- Migration: Extend Sales Dashboard Stats to include Phone Number for Latest Accounts
-- Purpose: Add phone_number to the latestAccounts response in get_sales_dashboard_stats
