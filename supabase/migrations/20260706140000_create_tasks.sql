...
-- Grant permissions
GRANT ALL ON TABLE core.tasks TO authenticated, service_role;
GRANT ALL ON TABLE core.task_relations TO authenticated, service_role;
GRANT ALL ON TABLE core.task_time_logs TO authenticated, service_role;
